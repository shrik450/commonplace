...
export function ReaderPageView({
  ...
  return (
    <Layout title={item.title} settings={settings}>
      ...
      >
        <article aria-labelledby="reader-title">
          <header class="cp-rule font-chrome pb-6">
            <h1 id="reader-title" class="font-reading text-3xl leading-tight text-pretty">{item.title}</h1>

<!-- Vendored from https://github.com/vercel-labs/web-interface-guidelines
     Source file: command.md on main.
     Fetched: 2026-09-02. Commit of the skills repo that pointed here:
     vercel-labs/agent-skills, skills/web-design-guidelines/SKILL.md.
     Refresh with the command in ../SKILL.md. Do not edit by hand. -->
